...
if __name__ == '__main__': 
    ...
    # SPI write bits
    ret = SPI_WriteBits(DevHandles[DevIndex],SPI2_CS0,b"10110100100101")
    if(ret != SPI_SUCCESS):
    ...
    ret = SPI_ReadBits(DevHandles[DevIndex],SPI2_CS0,ReadBuffer,20)
    if(ret != SPI_SUCCESS):
        ...
        print("")
    # SPI write read bits
    ret = SPI_WriteReadBits(DevHandles[DevIndex],SPI2_CS0,b"10110100100101",ReadBuffer,10)
    if(ret != SPI_SUCCESS):
