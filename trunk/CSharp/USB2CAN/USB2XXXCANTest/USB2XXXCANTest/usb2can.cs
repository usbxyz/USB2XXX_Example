...
namespace USB2XXX
{
    class USB2CAN
    {
        ...
        [DllImport("USB2XXX.dll")]
        public static extern Int32 CAN_SendMsg(Int32 DevIndex, Byte CANIndex, [In]CAN_MSG[] pCanSendMsg, UInt32 SendMsgNum);
        [DllImport("USB2XXX.dll")]
        public static extern Int32 CAN_GetMsg(Int32 DevIndex, Byte CANIndex, [Out]CAN_MSG[] pCanGetMsg);
        [DllImport("USB2XXX.dll")]
        ...
        [DllImport("USB2XXX.dll")]
        public static extern Int32 CAN_BL_NodeCheck(Int32 DevIndex, Int32 CANIndex, UInt16 NodeAddr, [Out]UInt32[] pVersion, [Out]UInt32[] pType, UInt32 TimeOut);
        [DllImport("USB2XXX.dll")]
