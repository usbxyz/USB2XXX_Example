...
namespace USB2XXXPWMTest
{
    class Program
    {
        ...
        //初始化PWM
        ret = USB2PWM.PWM_Init(DevIndex,ref PWMConfig);
        ...
        ret = USB2PWM.PWM_Start(DevIndex,PWMConfig.ChannelMask,RunTimeOfUs);
        if(ret != USB2PWM.PWM_SUCCESS){
        ...
        //停止PWM
        /*
        ret = USB2PWM.PWM_Stop(DevIndex,PWMConfig.ChannelMask);
        if (ret != USB2PWM.PWM_SUCCESS)
        {
