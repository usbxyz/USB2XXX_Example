...
namespace USB2XXX
{
    class USB2LIN
    {
        ...
        public static extern Int32  LIN_EX_Init(Int32 DevHandle,unsigned Byte LINIndex,Int32 BaudRate,Byte MasterMode);
        [DllImport("USB2XXX.dll")]
        public static extern Int32  LIN_EX_MasterSync(Int32 DevHandle,unsigned Byte LINIndex,LIN_EX_MSG[] pInMsg,LIN_EX_MSG[] pOutMsg,Int32 MsgLen);
        [DllImport("USB2XXX.dll")]
        public static extern Int32  LIN_EX_SlaveSetIDMode(Int32 DevHandle,unsigned Byte LINIndex,LIN_EX_MSG[] pLINMsg,Int32 MsgLen);
        [DllImport("USB2XXX.dll")]
        public static extern Int32  LIN_EX_SlaveGetData(Int32 DevHandle,unsigned Byte LINIndex,LIN_EX_MSG[] pLINMsg);
