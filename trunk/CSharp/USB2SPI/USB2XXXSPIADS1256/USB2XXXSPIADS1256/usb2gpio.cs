    ...
    class USB2GPIO
    {
        ...
        /**
          ...
          */
          ...
          public static extern Int32 GPIO_SetInput(Int32 DevIndex,UInt32 PinMask, Byte PuPd);
        /**
          ...
          */
          [DllImport("USB2XXX.dll")]
          public static extern Int32 GPIO_SetOutput(Int32 DevIndex,UInt32 PinMask, Byte PuPd);
        /**
          ...
          */
          [DllImport("USB2XXX.dll")]
          public static extern Int32 GPIO_SetOpenDrain(Int32 DevIndex,UInt32 PinMask, Byte PuPd);
        /**
          * @brief  设置GPIO引脚的输出状态
          * @param  DevIndex 设备索引号
          ...
          */
          [DllImport("USB2XXX.dll")]
          public static extern Int32 GPIO_Write(Int32 DevIndex,UInt32 PinMask, UInt32 PinValue);
        /**
          * @brief  获取GPIO引脚的输入状态
          * @param  DevIndex 设备索引号
          ...
          */
          [DllImport("USB2XXX.dll")]
          public static extern Int32 GPIO_Read(Int32 DevIndex,UInt32 PinMask, ref UInt32 pPinValue);
    }
}
