        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int DevIndex=0;DevIndex<DevNum;DevIndex++) {
                    int DevHandlet = DevHandleArry[DevIndex];
                    //打开设备
                    state = USB_Device.INSTANCE.USB_OpenDevice(DevHandlet);
                    if (!state) {
                    ...
                    try {
                        ...
                        state = USB_Device.INSTANCE.DEV_GetDeviceInfo(DevHandlet, DevInfo, funcStr);
                        if (!state) {
                            USB_Device.INSTANCE.USB_CloseDevice(DevHandlet);
