...
void GetAdcDataHandle(int DevIndex,unsigned short *pData,int DataNum)
{
...
int main(int argc, const char* argv[])
{
    ...
    ret = ADC_StartContinueRead(DevIndex,ADC_Channel,1000000,NULL);
    if(ret != ADC_SUCCESS){
        printf("Start Continue Read adc error!\n");
        return 0;
    }else{
        printf("Start Continue Read ADC Success!\n");
    }
#ifndef OS_UNIX
    Sleep(3000);
#else
