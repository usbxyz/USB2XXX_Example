...
public interface USB2GPIO extends Library {
	...
	/**
	  ...
	  */
	int  GPIO_SetInput(int DevIndex,int PinMask, byte PuPd);
	/**
	  ...
	  * @retval 函数执行状态，小于0函数执行出错
	  */
	int  GPIO_SetOutput(int DevIndex,int PinMask, byte PuPd);
	/**
	  ...
	  * @retval 函数执行状态，小于0函数执行出错
	  */
	int  GPIO_SetOpenDrain(int DevIndex,int PinMask, byte PuPd);
	/**
	  * @brief  设置GPIO引脚的输出状态
	  * @param  DevIndex 设备索引号
	  ...
	  * @retval 函数执行状态，小于0函数执行出错
	  */
	int  GPIO_Write(int DevIndex,int PinMask, int PinValue);
	/**
	  * @brief  获取GPIO引脚的输入状态
	  * @param  DevIndex 设备索引号
	  ...
	  * @retval 函数执行状态，小于0函数执行出错
	  */
	int  GPIO_Read(int DevIndex,int PinMask, int[] pPinValue);
